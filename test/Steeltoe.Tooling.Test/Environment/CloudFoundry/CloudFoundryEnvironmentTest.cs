...
namespace Steeltoe.Tooling.Test.Environment.CloudFoundry
{
    public class CloudFoundryEnvironmentTest
    {
        private CloudFoundryEnvironment env;

        public CloudFoundryEnvironmentTest()
        {
            env = new CloudFoundryEnvironment();
        }

        [Fact]
        public void TestGetName()
        {
            env.GetName().ShouldBe("cloud-foundry");
        }
